...
import { Component, Provider, ComponentContainer } from '@firebase/component';
import { stringify, jsonEval, contains, base64, stringToByteArray, Sha1, assert, isNodeSdk, deepCopy, base64Encode, isMobileCordova, stringLength, Deferred, safeGet, isAdmin, isValidFormat, isEmpty, isReactNative, assertionError, map, querystring, errorPrefix, getModularInstance, validateArgCount, validateCallback, validateContextObject } from '@firebase/util';
...
function registerDatabase$1(instance) {
    // set SDK_VERSION
...
registerDatabase$1(firebase);

export { DataSnapshot$1 as DataSnapshot, Database, OnDisconnect$1 as OnDisconnect, Query, Reference, ServerValue, enableLogging$1 as enableLogging, registerDatabase$1 as registerDatabase };
