...
class InternshipsForMeScreen extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            loading: true,
            internships: [
                <InternshipResult title={"Software Engineering Intern"} company={"Amazon"} apply={""}
                                  description={"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ornare faucibus justo, vitae lobortis arcu\n" +
