    ...
    handleForgotPassword = () => {
        ...
        firebase
            ...
            .then(() => {
                ...
                this.setState({errorMessage: "A password reset link has been sent to your email address, please reset your password and try logging in again. You will be redirected to the login page."});
    ...
    render() {
        return (
            <div className="main-div">
                ...
                <br/>
                <CustomButton value={"Reset Password"} onClick={this.handleForgotPassword}/>
            </div>
        );
    }
